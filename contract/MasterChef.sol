...
import 'token/BEP20/DexToken.sol';
...
contract MasterChef is Ownable {
    ...
    // Update the given pool's Dex allocation point and deposit fee. Can only be called by the owner.
    ...
    // Deposit LP tokens to MasterChef for Dex allocation.
    ...
    function updateEmissionRate(uint256 _DexPerBlock) public onlyOwner {
        massUpdatePools();
        DexPerBlock = _DexPerBlock;
    }

    function transferDexTokenOwnership(newOwner) public onlyOwner {
